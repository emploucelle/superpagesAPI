...
class CreateListingWorkinghoursTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('listing_workinghours', function (Blueprint $table) {
            ...
            $table->integer('mon_status')->nullable()->default('');
            ...
            $table->integer('tue_status')->nullable()->default('');
            ...
            $table->integer('wed_status')->nullable()->default('');
            ...
            $table->integer('thu_status')->nullable()->default('');
            ...
            $table->integer('fri_status')->nullable()->default('');
            ...
            $table->integer('sat_status')->nullable()->default('');
            ...
            $table->integer('sun_status')->nullable()->default('');
